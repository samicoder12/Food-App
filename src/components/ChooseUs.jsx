    ...
    <div className='flex justify-center px-2 md:px-6 lg:px-10 mt-6 sm:mt-8 lg:mt-16  2xl:px-80 2xl:mt-28'>
        <div className="grid grid-cols-1 lg:grid-cols-2 space-x-0 space-y-6 lg:space-y-0 lg:space-x-10">
            ...
            <div data-aos="fade-left"
                ...
                <img className='rounded-2xl object-cover w-full ' src="https://media.istockphoto.com/id/1446478827/photo/a-chef-is-cooking-in-his-restaurants-kitchen.jpg?s=612x612&w=0&k=20&c=jwKJmGErrLe2XsTWNYEEyiNicudYVA4j8jvnTiJdp58=" alt="hero image1" />
            </div>
        </div>
    </div>
  )
